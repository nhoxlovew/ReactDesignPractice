...
const JohnSmith = () => {
    return (
        <div className="relative">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToQ2y9CwRuX2PrwuJqot2t2UyrBpCUvq6-ocofyYIDOZo7WpcGrpKGbJXX6k0B6lIdkRU&usqp=CAU" className="absolute -z-10 h-screen" />
            <div className="flex  w-full h-screen justify-center items-center ">

                <div className="border-1 bg-white/10 w-[300px] h-[400px] flex flex-col justify-center items-center rounded-2xl">
